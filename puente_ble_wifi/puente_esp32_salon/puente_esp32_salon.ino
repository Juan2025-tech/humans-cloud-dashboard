...
#define BRIDGE_ID "ESP32_SALON"

// Configuración WiFi
const char* WIFI_SSID = "MOVISTAR-WIFI6-1A50";
const char* WIFI_PASSWORD = "AKpQXTCehuWJuokKL2du";

// Configuración Proxy (Mac Mini)
const char* PROXY_URL = "http://192.168.1.37:5050/api/data";
const char* PROXY_STATUS_URL = "http://192.168.1.43:5050/api/bridge/status";
